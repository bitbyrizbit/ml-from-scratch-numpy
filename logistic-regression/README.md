...
## Dataset Source
Sourced from `sklearn.datasets.load_breast_cancer` — originally from the 
[UCI Machine Learning Repository](https://archive.ics.uci.edu/ml/datasets/Breast+Cancer+Wisconsin+%28Diagnostic%29).
> W.N. Street, W.H. Wolberg, O.L. Mangasarian, 1993 — "Nuclear feature extraction for breast tumor diagnosis."
---
...
Results closely matched sklearn's output (~95% accuracy), confirming the correctness of gradient computation and optimization logic.

---

## Sample Output
> Loss curve and threshold analysis plots are saved to `outputs/plots/`.  
> See `notebooks/logistic_regression_walkthrough.ipynb` for full output.
---
...
Run the walkthrough:
```bash
jupyter notebook notebooks/logistic_regression_walkthrough.ipynb
```
---
