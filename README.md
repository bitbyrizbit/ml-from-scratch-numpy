...
- [x] Regularization — L1 & L2, bias-variance tradeoff, sparsity (Lasso), weight shrinkage (Ridge)
- [x] Stochastic Gradient Descent — mini-batch optimization, convergence comparison
- [x] Neural Network — extending logistic regression to multiple layers from scratch
